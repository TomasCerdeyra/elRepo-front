    ...
    <div className="min-h-screen flex flex-col bg-[#EFF3F5]">
      ...
      <div className="flex-grow flex flex-col items-center justify-center">
        ...
        <Link to={"/admin/gestioncarreras"}>
          <button className="hover:bg-[#3b6b5e] hover:shadow-md transition duration-200 bg-[#4F847C] text-white w-full font-light py-3 px-1 text-sm sm:text-md md:text-lg lg:text-1xl xl:text-2xl">
            Gestion de Carreras
          </button>
        </Link>
