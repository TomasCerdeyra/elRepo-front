    ...
    <div>
      ...
      <div className="w-full h-44 bg-[#16353B] mt-1 flex flex-col justify-center items-center">
        ...
        <div className='flex space-x-2'>
          ...
          <a href=" mailto:material.elrepo@gmail.com" className='underline text-[#959500] font-medium text-center text-sm md:text-xl lg:text-xl xl:text-xl'>material.elrepo@gmail.com</a>        </div>
      </div>
    </div>
  )
}
